...
public class UserController {
     ...
     * 用户登录
     *
     * 这里由于使用了自动化序列成json的工具
     * 使用@ResponseBody注解会直接传递一个json
     * @param username
     * @param password
     * @param session
     * @return
    ...
    @ResponseBody
    public ServerResponse<String> forget_rest_password(String username,String passwordNew, String forgetToken){
    ...
    public ServerResponse<User> update_information(HttpSession session,User user){
        ...
        //由于到时候直接使用一个对象来进行更新,而id是不会更改的,所以此处设置一下原id
